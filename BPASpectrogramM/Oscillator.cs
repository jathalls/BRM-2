namespace BPASpectrogramM
{
    ...
    public class Oscillator
    {
        ...
        public Oscillator(WavFormatInfo format, float frequency)
        {
            Format = format;
            Frequency = frequency;
        ...
        private float _frequency = 50000;
        // Parameters
        /// <summary>
        ...
        public float Frequency
        {
            ...
            {
                _frequency = value;
                _phaseIncrement = (float)(2.0 * Math.PI * _frequency / Format.SampleRate);
            }
        }
        ...
        /// </summary>
        public float PulseWidth { get; set; } = 0.001f;
        ...
        /// <inheritdoc/>
        public string Name { get; set; } = "Oscillator";

        /// <inheritdoc/>
        protected void GenerateAudio(Span<float> buffer, int channels)
        {
